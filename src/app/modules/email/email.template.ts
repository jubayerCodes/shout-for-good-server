import type { StripeReceiptEmailData } from "./email.service";
...
/**
 * Generate an HTML email that links to the Stripe-hosted receipt.
 */
export function generateStripeReceiptEmailHTML(data: StripeReceiptEmailData): string {
